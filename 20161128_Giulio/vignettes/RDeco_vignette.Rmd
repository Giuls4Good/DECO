...
A short description of the algorithm should be included here!!

## RDeco package

The package implements 4 different functions of the DECO algorithm:
\begin{itemize}
...
\item \texttt{DECO\char`_LASSO\char`_R\char`_CLUSTER}: a pure R implementation for splitting the work load on different machines (still in development).
\end{itemize}
